        ...
        public static string MakeValueCsvFriendly(object value)
        {
            ...
            if (value is DateTime)
            {
                if (((DateTime)value).TimeOfDay.TotalSeconds == 0)
                    return ((DateTime)value).ToString(ConfigHelper.GetConfig("DateFormat","dd/MM/yyyy"));
                return ((DateTime)value).ToString(ConfigHelper.GetConfig("DateTimeFormat", "dd/MM/yyyy HH:mm:ss"));
            }
