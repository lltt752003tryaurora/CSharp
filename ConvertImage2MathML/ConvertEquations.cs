...
namespace ConvertImage2MathML
{
    public class ConvertEquations
    {
        ...
        public abstract class EquationOutput
        {
            // c-tor
        ...
        public abstract class EquationOutputClipboard : EquationOutput
        {
        ...
        public class EquationOutputClipboardText : EquationOutputClipboard
        {
        ...
        public abstract class EquationOutputFile : EquationOutput
        {
        ...
        public class EquationOutputFileGIF : EquationOutputFile
        {
        ...
        public class EquationOutputFileWMF : EquationOutputFile
        {
        ...
        public class EquationOutputFileEPS : EquationOutputFile
        {
        ...
        public class EquationOutputFileText : EquationOutputFile
        {
        ...
        public abstract class EquationInput
        {
            // c-tor
            ...
            // get binary MTEF
            public abstract bool GetMTEF();
        }

        public abstract class EquationInputClipboard : EquationInput
        {
        ...
        public class EquationInputClipboardText : EquationInputClipboard
        {
        ...
        public class EquationInputClipboardEmbeddedObject : EquationInputClipboard
        {
        ...
        public abstract class EquationInputFile : EquationInput
        {
        ...
        public class EquationInputFileText : EquationInputFile
        {
        ...
        public class EquationInputFileWMF2 : EquationInputFile
        {
        ...
        public class EquationInputFileWMF : EquationInputFile
        {
            ...
            protected void Play()
            {
                try
                {
                    ...
                    using (Graphics graphics = wf.CreateGraphics())
                    {
                ...
                {
                    //Console.WriteLine(e.Message);
                    CLogger.WriteLogException("EquationInputFileWMF-Play-" + e.Message);
                }
            }
        ...
        public class EquationInputFileGIF : EquationInputFile
        {
        ...
        public class EquationInputFileEPS : EquationInputFile
        {
            ...
            protected bool ConvertToOutput()
            {
                ...
                try
                {
                        ...
                        SetTranslator())
                    {
                        ...
                        {
                            CLogger.WriteLogError("ConvertEquation - ConvertToOutput - MathType Error: " + stat.ToString() + ";");
                            //throw new Exception("MathTypeError_" + stat.ToString());
                        }
                    }
                }
                catch (Exception e)
                {
                    CLogger.WriteLogException("ConvertEquation - ConvertToOutput - " + e.Message);
